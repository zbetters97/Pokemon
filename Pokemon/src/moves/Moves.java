...
public enum Moves {
	...
	DIG ("Dig", "Physical", TypeEngine.ground, 10, 80, 100, 2, false, "dug into the ground!", "The user burrows, then attacks on the second turn. It can also be used to exit dungeons."),
	...
	FLY ("Fly", "Physical", TypeEngine.flying, 15, 90, 95, 2, false, "took flight!", "The user soars, then strikes on the second turn. It can also be used for flying to any familiar town."),
	...
	SOLARBEAM ("Solar Beam", "Special", TypeEngine.grass, 10, 180, 100, 2, true, "is charging Solar Beam...", "A two-turn attack. The user gathers light, then blasts a bundled beam on the second turn."),
