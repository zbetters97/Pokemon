...
public enum MovesEngine {
	...
	BLIZZARD ("Blizzard", "Special", TypeEngine.ice, StatusEngine.freeze, 0.10, 5, 120, 70, "A howling blizzard is summoned to strike the foe. It may also freeze the target solid."),
	...
	DIG ("Dig", "Physical", TypeEngine.ground, 10, 80, 100, false, "dug into the ground!", "The user burrows, then attacks on the second turn. It can also be used to exit dungeons."),
	...
	EXTREMESPEED ("Extreme Speed", "Phyiscal", TypeEngine.normal, 5, 80, 100, "The user charges the foe at blinding speed. This attack always goes before any other move."),
	...
	FLY ("Fly", "Physical", TypeEngine.flying, 15, 90, 95, false, "took flight!", "The user soars, then strikes on the second turn. It can also be used for flying to any familiar town."),
	...
	ICEFANG ("Ice Fang", "Physical", TypeEngine.ice, StatusEngine.freeze, 0.10, 15, 65, 95, "The user bites with cold-infused fangs. It may also make the foe freeze."),
	...
	SOLARBEAM ("Solar Beam", "Special", TypeEngine.grass, 10, 180, 100, true, "is charging Solar Beam...", "A two-turn attack. The user gathers light, then blasts a bundled beam on the second turn."),
	...
	TELEPORT ("Teleport", "Other", TypeEngine.psychic, 20, 0, -1, "Use it to flee from any wild Pokémon."),
	...
	/** CONSTRUCTORS **/
	MovesEngine (String name, String mtype, TypeEngine type, int pp, int power, int accuracy, String info) {
		this.name = name;
		this.mtype = mtype;
		this.type = type;
		this.pp = pp;
	...
	MovesEngine (String name, String mtype, TypeEngine type, boolean toSelf, int pp, int accuracy, int level, List<String> stats, String info) {
		this.name = name;
		this.mtype = mtype;
		this.type = type;
		this.toSelf = toSelf;
	...
	MovesEngine (String name, String mtype, TypeEngine type, boolean toSelf, Double probability, int pp, int power, int accuracy, int level, List<String> stats, String info) {
		this.name = name;
		this.mtype = mtype;
		this.type = type;
		this.toSelf = toSelf;
